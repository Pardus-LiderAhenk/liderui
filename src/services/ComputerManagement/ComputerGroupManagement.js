...
class ComputerGroupManagemetService{
	...
	async agentList(params) {
        try {
            const response = await axios.get(liderComputerAgentListSizeUrl, params);
            return { response };
        } catch (error) {
            return { error: error }
        }
...
export const computerGroupManagementService = new ComputerGroupManagemetService(axios); 
