<template>
    <div class="p-fluid p-formgrid p-grid">
        ...
        <Fieldset class="p-col-12 p-mb-3 "
            :legend="$t('settings.server_settings.directory_server_settings.open_ldap_settings')">

            <div class="p-fluid p-formgrid p-grid">
                <div class="p-field p-col-12 p-md-4">
                    <label
                        for="ldapServer">{{ $t('settings.server_settings.directory_server_settings.ldap_server_address') }}</label>
                ...
                <div class="p-field p-col-12 p-md-6">
                    <label
                        for="ldapRootDn">{{ $t('settings.server_settings.directory_server_settings.domain_name') }}</label>
                    <InputText id="ldapRootDn" type="text" v-model="ldapRootDn" disabled />
                </div>
                <div class="p-field p-col-12 p-md-6">
                    <label
                        for="ldapUsername">{{ $t('settings.server_settings.directory_server_settings.ldap_user_dn') }}</label>
                    <InputText id="ldapUsername" type="text" v-model="ldapUsername" />
                </div>
                <div class="p-field p-col-12 p-md-6">
                    <label
                        for="ldapPassword">{{ $t('settings.server_settings.directory_server_settings.ldap_user_password') }}</label>
                    <div class="p-inputgroup" v-if="ldapUsernameDefine">
                        <InputText type="password" value="******************" readonly />
                        <Button icon="pi pi-unlock" class="p-button-sm" type="button"
                            @click="changePasswordDialog = true"
                            :label="$t('settings.server_settings.directory_server_settings.change_password')" />
                    </div>
                    <div class="p-inputgroup" v-else>
                        <InputText type="password" value="" readonly />
                        <Button icon="pi pi-save" class="p-button-sm" type="button" @click="changePasswordDialog = true"
                            :label="$t('settings_password.create_password')" />
                    </div>
                </div>
                <div class="p-field p-col-12 p-md-6">
                    <label
                        for="agentLdapBaseDn">{{ $t('settings.server_settings.directory_server_settings.ahenk_folder') }}</label>
                    <InputText id="agentLdapBaseDn" type="text" v-model="agentLdapBaseDn" disabled />
                </div>
                <div class="p-field p-col-12 p-md-6">
                    <label for="userLdapBaseDn">{{ $t('settings.server_settings.directory_server_settings.user_folder')
                        }}</label>
                    <InputText id="userLdapBaseDn" type="text" v-model="userLdapBaseDn" disabled />
                </div>
                <div class="p-field p-col-12 p-md-6">
                    <label for="groupLdapBaseDn">{{
                        $t('settings.server_settings.directory_server_settings.group_folder') }}</label>
                    <InputText id="groupLdapBaseDn" type="text" v-model="groupLdapBaseDn" disabled />
                </div>
                <div class="p-field p-col-12 p-md-6">
                    <label for="ahenkGroupLdapBaseDn">{{
                        $t('settings.server_settings.directory_server_settings.agent_group_folder') }}</label>
                    <InputText id="ahenkGroupLdapBaseDn" type="text" v-model="ahenkGroupLdapBaseDn" disabled />
                </div>
                <div class="p-field p-col-12 p-md-6">
                    <label for="userGroupLdapBaseDn">{{
                        $t('settings.server_settings.directory_server_settings.user_group_folder') }}</label>
                    <InputText id="userGroupLdapBaseDn" type="text" v-model="userGroupLdapBaseDn" disabled />
                </div>
                <div class="p-field p-col-12 p-md-6">
                    <label for="userLdapRolesDn">{{
                        $t('settings.server_settings.directory_server_settings.authority_group_folder') }}</label>
        ...
        <Fieldset class="p-col-12 p-mb-3"
            :legend="$t('settings.server_settings.directory_server_settings.active_directory_settings')">
            <div class="p-fluid p-formgrid p-grid">
                <div class="p-field p-col-12 p-md-4">
                    <label for="adIpAddress">{{
                        $t('settings.server_settings.directory_server_settings.active_directory_address') }}</label>
                    <InputText id="adIpAddress" type="text" v-model="adIpAddress" />
                </div>
                <div class="p-field p-col-12 p-md-2">
                    <label for="adPort">{{
                        $t('settings.server_settings.directory_server_settings.active_directory_port') }}</label>
                    <InputText id="adPort" type="text" v-model="adPort" />
                </div>
                <div class="p-field p-col-12 p-md-6">
                    <label for="adDomainName">{{
                        $t('settings.server_settings.directory_server_settings.active_directory_domain_name') }}</label>
                    <InputText id="adDomainName" type="text" v-model="adDomainName" />
                </div>
                <div class="p-field p-col-12 p-md-6">
                    <label for="adAdminUserName">{{
                        $t('settings.server_settings.directory_server_settings.active_directory_admin_username')
                        }}</label>
                    <InputText id="adAdminUserName" type="text" v-model="adAdminUserName" />
                </div>
                <div class="p-field p-col-12 p-md-6">
                    <label for="adAdminUserFullDN">{{
                        $t('settings.server_settings.directory_server_settings.active_directory_admin_dn') }}</label>
                    <InputText id="adAdminUserFullDN" type="text" v-model="adAdminUserFullDN" />
                </div>
                <div class="p-field p-col-12 p-md-6">
                    <label for="adHostName">{{
                        $t('settings.server_settings.directory_server_settings.active_directory_hostname') }}</label>
                    <InputText id="adHostName" type="text" v-model="adHostName" />
                </div>
                <div class="p-field p-col-12 p-md-6">
                    <label for="adAdminPassword">{{
                        $t('settings.server_settings.directory_server_settings.active_directory_admin_password')
                        }}</label>
                    <InputText type="password" v-model="adAdminPassword" placeholder="******************"/>
                </div>
                <div class="p-field p-col-12 p-md-6 p-grid">
                    <div class="p-field p-md-4">
                        <label for="userLdapRolesDn">{{
                            $t('settings.server_settings.directory_server_settings.ssl_certification') }}</label>
                        <Dropdown v-model="adUseSSL" :options="yesNoDropdown" optionLabel="label" optionValue="value" />
                    </div>
                    <div class="p-field  p-md-4">
                        <label for="userLdapRolesDn">{{
                            $t('settings.server_settings.directory_server_settings.tls_certification') }}</label>
                        <Dropdown v-model="adUseTLS" :options="yesNoDropdown" optionLabel="label" optionValue="value" />
                    </div>
                    <div class="p-field  p-md-4">
                        <label for="userLdapRolesDn">{{
                            $t('settings.server_settings.directory_server_settings.use_certification') }}</label>
                        <Dropdown v-model="adAllowSelfSignedCert" :options="yesNoDropdown" optionLabel="label"
                            optionValue="value" />
                    </div>
                </div>
                <div class="p-field p-col-12 p-grid">
                    <div class="p-col p-as-start">
                        <a class="primary" type="secondary" @click="toggle"
                            v-tooltip.right="$t('settings.server_settings.directory_server_settings.ad_popover.title')">
                            <i class="el el-icon-question"></i>
                        </a>
                        <OverlayPanel ref="op" appendTo="body" :showCloseIcon="false" id="overlay_panel"
                            style="width: 450px" :breakpoints="{ '960px': '75vw' }">
                            <div>
                                <h5>{{ $t('settings.server_settings.directory_server_settings.ad_popover.title') }}</h5>
                            </div>
                            <ul>
                                <li>
                                    <small>
                                        {{
                                            $t('settings.server_settings.directory_server_settings.ad_popover.description')
                                        }}
                                    </small>
                                </li>
                                <li>
                                    <small>
                                        {{
                                            $t('settings.server_settings.directory_server_settings.ad_popover.check_connection')
                                        }}
                                    </small>
                                </li>
                                <li>
                                    <small>
                                        {{
                                            $t('settings.server_settings.directory_server_settings.ad_popover.save_settings')
                                        }}
                                    </small>
                                </li>
                            </ul>
                    ...
                    <div>
                        <Button icon="pi pi-wifi" class="p-button-sm" type="button" @click=checkADConnection
                            :label="$t('settings.server_settings.directory_server_settings.check_connection')" />
                    </div>
        ...
        <div class="p-field p-col-12 p-text-right">
            <div class="p-d-flex p-jc-end">
                <div>
                    <Button icon="pi pi-save" type="button"
                        :label="$t('settings.server_settings.directory_server_settings.save')"
    ...
    <SettingsPasswordComponet v-if="changePasswordDialog" :visible="changePasswordDialog" :type="'ldapPassword'"
        :settingsOldPassword="ldapUsernameDefine" @updatedPassword="updatedLdapPassword"
        @update:visible="changePasswordDialog = false" />

    <Dialog :header="$t('settings.server_settings.directory_server_settings.update_settings')"
        v-model:visible="showDialog" :style="{ width: '20vw' }" :modal="true">
        <div class="p-fluid">
...
export default {
    ...
    methods: {
        ...
        async checkADConnection() {

            if (this.adAdminPassword == '' || this.adAdminPassword == null) {
                this.$toast.add({
                    severity: 'warn',
                    detail: this.$t('settings.server_settings.directory_server_settings.password_empty'),
                    summary: this.$t("computer.task.toast_summary"),
                    life: 3000
                });
                return;
            ...
            const { response, error } = await serverSettingService.checkADConnection(data);

            if (error) {
                if (error.response.status == 406) {
                    this.$toast.add({
                        severity: 'error',
                        detail: this.$t('settings.server_settings.directory_server_settings.connection_missing_credentials'),
                        summary: this.$t("computer.task.toast_summary"),
                        life: 3000
                    });
                }
                    ...
                    this.$toast.add({
                        severity: 'error',
                        detail: this.$t('settings.server_settings.directory_server_settings.connection_failed'),
                        summary: this.$t("computer.task.toast_summary"),
                        life: 3000
                    });
                }
                ...
                if (response.status == 200) {
                    this.$toast.add({
                        severity: 'success',
                        detail: this.$t('settings.server_settings.directory_server_settings.connection_success'),
                        summary: this.$t("computer.task.toast_summary"),
                        life: 3000
                    });
                }
